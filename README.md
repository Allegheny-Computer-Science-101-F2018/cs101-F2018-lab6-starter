...
# cs101-F2018-lab6-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 6 in Computer Science 101. Since
...
focusing on Code Fragment 4.1 and the text that discusses Figure 4.1. Please see
...
output for the instructor's version of `labsix.experiment.Experiment`.
Depending on both how you implement the password checking program and the
computer that you use for the experiments, your timing values and order of
growth ratios may be different when you run the experiment on your own computer.
Also, please note that this laboratory assignment invites you to run a
comprehensive JUnit test suite of multiple Java classes in multiple packages.
While this test suite does not produce any output, you should carefully inspect
its tests so that you understand their strategy.
...
- labsix/RunCampaign.java:
  - Contains at least four multi-line comments in the JavaDoc standard
  - Contains exactly 6 `println` statements to produce program output
  - Contains exactly zero of the comment fragment that marks incomplete tasks
...
```
git remote add download git@github.com:Allegheny-Computer-Science-101-F2018/cs101-F2018-lab6-starter.git
```
...
you can go to the [Computer Science 101 Lab 6
Starter](https://github.com/Allegheny-Computer-Science-101-F2018/cs101-F2018-lab6-starter)
